	...
	<form action="insert" method="post" enctype="multipart/form-data">
		...
		<table class="table table-bordered" style="width: 500px">
			...
			<tr>
				<th>사진</th>
				<td>
				<input type="file" name="uimage" class="form-control" style="width: 300px", multiple="multiple">
				</td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				...
				<button type="button" class="btn btn-info" onclick="location.href='list'" style="width: 100px;">목록</button>
				</td>
			</tr>
		</table>
	</form>

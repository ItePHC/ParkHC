...
function SevenApp(props) {
    ...
    return (
      ...
      <CardMedia
        component="img"
        height="194"
        // image={food=='1'?Food1:food=='2'?Food2:food=='3'?Food3:food=='4'?Food4:food=='5'?Food5:food=='6'?Food6:Food7}
        image={`../image2/${food}.jpg`}         // public경로 사용할것***
        alt="Paella dish"
      />
      <CardContent>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        ...
        <div>
            ...
            <select onChange={changeFood}>
                <option value='1'>클럽샌드위치</option>
                <option value='2'>꼬치</option>
                <option value='3'>장칼국수</option>
                <option value='4'>소갈비</option>
                <option value='5'>콘치즈</option>
                <option value='6'>오므라이스</option>
        ...
        <div>
            ...
            <select onChange={(e)=>{
                ...
                {
                    // 1부터 12까지 반복해서 option제공
                    [...new Array(7)].map((a,index)=>(<option>{index+1}</option>))            // 7개 제공
                }
            </select>
        </div>
    </div>

...
<body>
	...
	<table class="table table-bordered" style="width: 600px">
		...
		<tr>
			<th>바꿀이름</th>
			<td>
				<input type="text" name="intro_name" value="<%=dto.getIntro_name() %>" class="form-control" required="required" style="width: 400px">
			</td>
		</tr>
		...
		<tr>
			...
			<select id="intro_blood" class="form-control" value="<%=dto.getIntro_blood() %>" style="width: 100px" name="intro_blood">

...
<%
	...
	MallDto dto = dao.getMallData(no);
%>
</head>
<body>
	...
	<input type="hidden" name="no" value='<%=no%>'>
		...
		<tr>
			<th>상품명</th>
			<td>
				<input type="text" name="sangpum" class="form-control" required="required" style="width: 250px" value="<%=dto.getSangpum()%>">
			</td>
		</tr>
		...
		<tr>
			<th>가격</th>
			<td>
				<input type="text" name="price" class="form-control" required="required" style="width: 250px" value="<%=dto.getPrice()%>">
			</td>
		</tr>
		...
		<tr>
			<th>입고일</th>
			<td>
				<input type="date" name="ipgoday" class="form-control" required="required" style="width: 250px" value='<%=dto.getIpgoday()%>'>
			</td>
		</tr>
